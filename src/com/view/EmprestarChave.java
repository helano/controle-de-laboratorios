...
public class EmprestarChave extends JInternalFrame {
	Date data;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EmprestarChave frame = new EmprestarChave();
	...
	public EmprestarChave() {
	 ...
	 lblHoraDeEmprestimo = new JLabel("Hora de Emprestimo");
		...
		lblChave_1.setForeground(Color.RED);
		lblChave_1.setBounds(617, 53, 70, 14);
		getContentPane().add(lblChave_1);
