...
public class VerificarDataC extends JInternalFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VerificarDataC frame = new VerificarDataC();
	...
	public VerificarDataC() {
		...
		JLabel lblInserirDataPara = new JLabel("Inserir data para reserva de AUDITORIO");
